...
custom_packages() {
    ...
    wget https://nikkinikki.pages.dev/openwrt-24.10/aarch64_generic/nikki/nikki_2025.10.15-r1_aarch64_generic.ipk
    wget https://nikkinikki.pages.dev/openwrt-24.10/aarch64_generic/nikki/luci-app-nikki_1.24.3-r1_all.ipk
    wget https://github.com/gSpotx2f/packages-openwrt/raw/master/current/internet-detector_1.7.0-r1_all.ipk
    wget https://github.com/gSpotx2f/packages-openwrt/raw/master/current/luci-app-internet-detector_1.7.0-r1_all.ipk
...
rebuild_firmware() {
    ...
    my_packages="\
        acpid attr base-files bash bc blkid block-mount blockd bsdtar btrfs-progs busybox bzip2 openssh-sftp-server nano \
